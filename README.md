...
This page lists scientific publications in which gapIt is used. If you also have employed gapIt, send an email to olivier.parisot@list.lu to have your publication listed here.
