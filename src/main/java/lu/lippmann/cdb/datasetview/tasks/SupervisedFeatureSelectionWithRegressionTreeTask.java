 ...
 * @author the WP1 team
 */
public final class SupervisedFeatureSelectionWithRegressionTreeTask extends Task
{
	//
	// Instance fields
	//
	 ...
	 * Constructor.
	 */
	public SupervisedFeatureSelectionWithRegressionTreeTask()
	{
		this(true);
	}
	 ...
	 * Constructor.
	 */
	public SupervisedFeatureSelectionWithRegressionTreeTask(final boolean pruned)
	{
		this.dtFactory=new REPTreeDecisionTreeFactory(pruned);
	}
	...
	String getName() 
	{
		return "Simplify with pruned RT (superv.)";
	}
