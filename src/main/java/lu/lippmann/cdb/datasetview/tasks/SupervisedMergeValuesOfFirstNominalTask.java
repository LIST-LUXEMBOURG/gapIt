 ...
 * @author the WP1 team
 */
public final class SupervisedMergeValuesOfFirstNominalTask extends Task
{
	//
	// Instance methods
	//
	...
	String getName() 
	{
		return "Merge values of first nominal (superv.)";
	}
	...
	Instances process0(final Instances dataSet) throws Exception 
	{
		...
		if (idxs.length>0)
		{
			...
			final Instances newds=WekaDataProcessingUtil.buildDataSetWithSupervisedMergeNominalValues(dataSet,idx);
			return newds;
		}
		else
		{
